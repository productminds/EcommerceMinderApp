...
static NSString *const apiKey = [ReactNativeConfig envFor:@"BRAZE_API_KEY"];
static NSString *const endpoint = @"sdk.iad-06.braze.com";

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  self.moduleName = @"EcommerceMinderApp";
